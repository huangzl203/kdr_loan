...
<body>
	...
	<div class="box">
				...
				<div class="form">
					...
					<form action="#">
						...
						<div class="form-item" style="padding-bottom: 6px;">
							<label for="" class="lab">轻松购类型:</label>
							<p style="display:inline-block;">
								<label class=""><input type="radio"  id="0" checked name="loanType">轻松购A(长期)</label>
							</p>
						</div>
						<div>	
			...
			<div class="page">
				<div class="page2">
						<h2>门槛低</h2>
						<p>看似遥远的理想其实可以很快成为现实。轻松购 ，最低两万购房</p>
				</div>
			</div>
