  ...
  <div class="bottom_one">
    <div class="bottom_one_all">
      <ul>
        ...
        <li><a href="http://www.hehenian.com/callcenter.do?id=1#g1">关于我们</a> </li>
        <li><a href="http://www.hehenian.com/callcenter.do?id=1#g2">平台原理</a> </li>
        <li><a href="http://www.hehenian.com/callcenter.do?id=1#g3">资质证件</a> </li>
        <li><a href="http://www.hehenian.com/callcenter.do?id=1#g5">合作伙伴</a> </li>
      </ul>
      <ul>
        <li>
          <h2>安全保障</h2>
        ...
        <li><a href="http://www.hehenian.com/callcenter.do?id=1#g4">法律政策</a> </li>
        <li><a  href="http://www.hehenian.com/callcenter.do?id=4">本金保障</a> </li>
        <li><a  href="http://www.hehenian.com/callcenter.do?id=8">风险披露</a> </li>
        <li><a  href="http://www.hehenian.com/callcenter.do?id=7">免责声明</a> </li>
      </ul>
      <ul>
        <li>
          <h2>帮助信息</h2>
        ...
        <li style=" height:5px;"></li>
        <li style="display: none"><a href="http://www.hehenian.com/callcenter.do?type=true&cid=1">新手入门</a> </li>
        <li><a href="http://www.hehenian.com/callcenter.do?id=2">操作指引</a> </li>
        <li> 
          <!--<a href="callcenter.do?showkf=kfs">客服中心</a>--> 
          <a href="http://www.hehenian.com/callcenter.do?id=3">常见问题</a> </li>
      ...
      <ul>
        ...
        <li><a href="http://www.hehenian.com/callcenter.do?showkf=kfs">客服中心</a> </li>
        <li><a href="javascript:void(0)"></a> </li>
        <li><a href="javascript:void(0)"></a> </li>
      </ul>
      <%--<div class="bottom_erwm"> <img src="/images/hynn.gif"  /> </div>--%>
      <div class="bottom_logo"> <img src="<c:url value='${fileServerUrl }/web_res/img/er_wema.jpg'/>"  width="142" height="142" /> </div>
      ...
      <div class="bottom_logo" style=" margin-right:35px;"> 
        ...
        <%--				<a href="http://webscan.360.cn/index/checkwebsite/url/www.hehenian.com" target="right">--%>
             ...
             <p style="float:left; margin-top:15px;"><a class="ui-footer-img-link weibo" href="http://weibo.com/u/3893072293" target="_blank">合和年新浪微博</a></p>
              <p style="float:left; margin-top:15px;"><a class="ui-footer-img-link we-chat" href="<c:url value='${fileServerUrl }/web_res/img/er_wema.jpg'/>"  rel="lytebox" title="请扫描二维码，添加微信账号<br />
获取海量投资资讯及最新优惠信息">合和年微信</a></p>
  ...
  <div class="bottom_two" style=" padding-top:25px; ">
  	<div style=" width:1170px; margin:0px auto">
    	<div  style="float:left; width:100%; text-align:center;">  <a href="http://www.hehenian.com/index.jsp" class="bottom_two">© 2014 深圳市彩付宝网络技术有限公司 </a>&nbsp;&nbsp;&nbsp;&nbsp;花样年集团成员（港联交所上市企业HK1777）&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--底部footer 结束--> 
<script type="text/javascript" src="<c:url value='${fileServerUrl }/web_res/js/jqueryV172.js'/>"></script>
<script type="text/javascript" src="<c:url value='${fileServerUrl }/web_res/js/xl.js'/>"></script>
...
@font-face{font-family:"Merriweather";src:url("<c:url value='${fileServerUrl }/web_res/font/Merriweather.ttf'/>");}


#rightButton{ position:fixed; _position:absolute; top:208px; right:0; z-index:999999; display:block;}
#right_ul{ position:relative;}
#right_qq{  background:url(<c:url value='${fileServerUrl }/web_res/img/7_03.png'/>) no-repeat; width:38px; height:41px; }
#right_tel{ background:url(<c:url value='${fileServerUrl }/web_res/img/7_05.png'/>) no-repeat; width:38px; height:41px; }
#right_tip{  background:url(<c:url value='${fileServerUrl }/web_res/img/flag_right.png'/>) no-repeat; width:252px; height:91px; position:absolute; right:40px; top:-10px; display:none; z-index:999999; }
...
a.backToTop_a{  background:url(<c:url value='${fileServerUrl }/web_res/img/7_08.png'/>) no-repeat; width:38px; height:44px; display:block; }
a.backToTop_a:active{  background:url(<c:url value='${fileServerUrl }/web_res/img/7_11.png'/>) no-repeat; }
