...
<div class="header">
  <div class="header_one">
    <div class="header_one_center">
      ...
      <div style="float:left; margin-top:0px;" > <a href="${loanServerUrl}"><img src="<c:url value='${fileServerUrl }/web_res/img/logo_zaixian.png'/>" style=" border:0px;" alt="合和年在线"/> </a></div>
      ...
      <p style="float:left; margin-top:15px;"><a class="ui-top-img-link we-chat" href="<c:url value='${fileServerUrl }/web_res/img/er_wema.jpg'/>"  rel="lytebox" title="请扫描二维码，添加微信账号，获取海量投资资讯及最新优惠信息">合和年微信</a></p>
      </div>
        ...
        <ul >
         <!--  <li style=" border-left:1px solid #FFF; padding:0px 0px 0px 10px; float:right; width:80px;"><span><a id='reg'>免费注册</a></span></li> -->
          <li style="border-right:1px solid #ccc ; padding:0px 20px; float:right; overflow:hidden; height:48px;"><span>
            <c:if test="${userAccount !=null}"><a id='home' >[${userAccount.userShow}]</a> <span></span> <a id='logout' href="<c:url value='/'/>">退出</a> </c:if>
            <c:if test="${userAccount ==null}"><a id='login' >登录</a></c:if>
            </span></li>
        </ul>
      </div>
    </div>
